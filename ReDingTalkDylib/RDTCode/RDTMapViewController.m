...
@interface RDTMapViewController() <MKMapViewDelegate, CLLocationManagerDelegate, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate>
@end

@implementation RDTMapViewController {
    MKMapView * _mapView;
...
- (void)_initLocationManager {
    ...
    NSString * locationIconPath = [[NSBundle bundleForClass:[RDTMapViewController class]] pathForResource:@"icon_current_location" ofType:@"png"];
    [_locationButton setImage:[UIImage imageWithContentsOfFile:locationIconPath]
...
- (void)mapView:(MKMapView *)mapView didSelectAnnotationView:(MKAnnotationView *)view {
    ...
    UIAlertAction * deleteAction = [UIAlertAction actionWithTitle:@"删除"
        ...
        if (view.annotation.coordinate.latitude == self.location.coordinate.latitude && view.annotation.coordinate.longitude == self.location.coordinate.longitude && self.completion) {
            self.completion(@{});
        }
    }];
